    ...
    <span class="badge badge-warning badge-right"></span>
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-sm-9">
							    ...
							    <div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="nip" >NIP/NIK :</label>
									...
									<div class="col-sm-9">
										...
										<input type="text" name="nip" id="nip" class="col-xs-10 col-sm-3" data-rel="tooltip" title="NIP BARU" placeholder="NIP/NIK" value="<?php echo $p_nip;?>" required/>
					 ...
					 -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-9">
                                        <input type="email" name="email_k" id="email_k" class="col-xs-10 col-sm-3" placeholder="Email" value="<?php echo $p_email_k;?>" />
                                    </div>
                                </div>
				
				
				<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="tlpn">No. Telephone:</label> 
				...
				<input class="col-xs-10 col-sm-2" value="<?php echo $p_hp;?>" type="text" name="hp" id="hp" placeholder="Isikan No Hp">
                    <input class="col-xs-10 col-sm-2" value="<?php echo $p_nofax;?>" type="text" name="fax" id="fax" placeholder="Isikan No Fax">
								...
								<div class="form-group ">
									...
									<div class="col-sm-9">
										<input type="text" name="noktp" id="noktp" class="col-xs-10 col-sm-4" placeholder="Nomer Induk Kependudukan" value="<?php echo $p_noktp;?>" required/>
									</div>
							...
							<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right">Bank Transfer & Asuransi :</label>
											...
											<input type="text" name="norek" value="<?php echo $p_norek;?>" id="norek" placeholder="Nomor Rekening" />
                                                <input type="text" name="nojamsos" value="<?php echo $p_nojamsos;?>" id="nojamsostek" placeholder="No. BPJSTK" />
                                                 <input type="text" name="nodplk" value="<?php echo $p_nodplk;?>" id="norek" placeholder="No. BPJS Kesehatan" />
                                                 <input type="text" name="nojiwa" value="<?php echo $p_nojiwa;?>" id="No.Jiwasaraya" placeholder="No. Asusransi Lain" />
											</span>
											</div>
