...
<head>
	...
	<meta charset="utf-8" />
	<title>Register - SIM-PEG (Administrasi Sistem Kepegawaian)</title>
...
<div class="center">
	<h1>
		...
		<span class="red">SIM-PEG</span><span class="white"> ONLINE</span>
	</h1>
	...
	<div id="login-box" class="login-box visible widget-box no-border">
		<div class="widget-body">
			<div class="widget-main">
				...
				<div class="form-group">
						 <span class="lbl">
						  <div class="alert alert-danger">Untuk Registrasi UserID Pegawai, Pegawai harus sudah memiliki NIP/NIK </div>
						 </span>
				</div>
			</div><!-- /.widget-main -->
